    ...
    export default {
        ...
        methods: {
            ...
            submitAddress() {
                ...
                if (userAction === 0) {
                    method = 'post', url = '/shipping/add';
                } else if (userAction === 1) {
                    method = 'put', url = `/shipping/update/${checkedItem.id}`;
                } else {
                    method = 'delete', url = `/shipping/delete/${checkedItem.id}`;
                }
                if (userAction === 0 || userAction === 1) {
                    ...
                    params = {
                        receiverName,
                        receiverMobile,
                        receiverPhone: checkedItem.receiverMobile,
                        receiverProvince,
                        receiverCity,
                        receiverDistrict,
                        receiverAddress,
            ...
            getAddressList() {
                this.axios.get('/shipping/list').then((res) => {
                    this.list = res.list;
                })
            },
            getCartList() {
