...
<script>
    ...
    import ScanPayCode from './../components/scan-pay-code'
    ...
    export default {
        ...
        methods: {
            getOrderDetail() {
                this.axios.get(`/order/detail/${this.orderId}`).then((res) => {
            ...
            paySubmit(payType) {
                if (payType === 1) {
                    window.open('/#/order/ali-pay?orderId=' + this.orderId, '_blank');
                } else {
